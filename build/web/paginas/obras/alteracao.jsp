<%-- 
    Document   : alteracao
    Created on : 20/05/2011, 14:24:09
    Author     : agostinho
...
<html>
    ...
    <body>
        <a4j:form id="a4jFormPesquisaAlteracaoObras">
        ...
        <a4j:form id="a4jFormAlteracaoObras">
            <rich:modalPanel  tridentIVEngineSelectBehavior="hide" id="confirmacao" height="80"  width="240"  zindex="1000"
                ...
                <h:outputText value="Tem certeza que deseja alterar os dados da obra?" style="margin-top:50px;" escape="false"/>
                <h:messages id="confirmacaoAlert" errorStyle="color: #E65D32;" infoStyle="color: #0051E5" warnStyle="color: #FAAC17"/>
                <BR/><BR/><BR/><BR/><BR/><BR/>
                <a4j:commandButton value="  Sim  " actionListener="#{ObrasBean.alterar}" style="margin-left: 55px;"
        ...
        <a4j:commandButton id="botaoAtualizar" value="    Alterar    " disabled="#{ObrasBean.habilitarBotaoAtualizar}"

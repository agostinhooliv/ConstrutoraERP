<%-- 
    Document   : mesangens
    Created on : 24/05/2011, 10:15:03
    Author     : agostinho
...
<html>
    ...
    <body>
        <rich:modalPanel  tridentIVEngineSelectBehavior="hide" id="mensagens" height="80"  width="240"  zindex="1000"
            ...
            <BR/><BR/>
            <h:commandLink value="  Fechar  " style="margin-left: 90px;" onclick="Richfaces.hideModalPanel('mensagens');" actionListener="#{FornecedoresBean.fechar}"/>

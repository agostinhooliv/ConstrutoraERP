<%-- 
    Document   : mensagens
    Created on : 20/05/2011, 20:54:46
    Author     : HOME
...
<html>
    ...
    <body>
        <rich:modalPanel  tridentIVEngineSelectBehavior="hide" id="mensagens" height="80"  width="240"  zindex="1000"
            ...
            <BR/><BR/>
            <h:commandLink value="  Fechar  " style="margin-left: 90px;" onclick="Richfaces.hideModalPanel('mensagens');" actionListener="#{FuncionariosBean.fechar}"/>
